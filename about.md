...
tagline: |-
  Kubernetes 기반 플랫폼의 구축과 운영, 자동화에 강점을 가진 엔지니어입니다.
  
  클러스터 운영 과정에서 발생하는 문제를 직접 분석하고 해결하며,
  반복되는 운영 작업을 자동화하고 OSS를 활용해 운영 효율과 장애 대응력을 개선해왔습니다.
---
...
> - ArgoCD ApplicationSets를 통한 멀티클러스터의 GitOps 중앙 관리 생태계 구축
